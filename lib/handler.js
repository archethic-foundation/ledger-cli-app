...
class ArchethicHandler {
    ...
    sendSignTxn = (address_index, receiver, amount, encrypted_key_plus_wallet) => {
        this.connectDevice()
        return new Promise((resolve, reject) => {
            ...
            this.instance
                .then(async (transport) => {
                    ...
                    console.log(txnAmount);
                    const recAddr = receiver.toUpperCase();
                    if (recAddr.length !== 68) {
                        throw "receiver needs to contain also curve_type!! Add 02 in front of address if you are using ARCHEthic wallet Address."
                    }
